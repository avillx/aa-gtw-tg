...
from ...models.activity_logs_response import ActivityLogsResponse
...
) -> ActivityLogsResponse | Error | None:
    if response.status_code == 200:
        response_200 = ActivityLogsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ActivityLogsResponse | Error]:
    return Response(
